...
public interface ConfigurationProxy {
  ...
  /**
   * Returns the Jira instance properties. If properties are not configured, it returns default
   * values.
   *
  ...
  /**
   * Returns the mail server instance properties. If properties are not configured, it returns
   * default values.
   *
